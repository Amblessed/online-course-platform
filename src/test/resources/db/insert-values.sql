...
INSERT INTO tbl_instructors (instructor_id, first_name, last_name, summary, user_id) VALUES
(1, 'instructor1FN', 'instructor1LN', 'Experienced Instructor', 3),
(2, 'instructor2FN', 'instructor2LN', 'Senior Instructor', 4);

INSERT INTO tbl_students (student_id, first_name, last_name, level, user_id) VALUES
(1, 'std1FN', 'std1LN', 'beginner', 5),
(2, 'std2FN', 'std2LN', 'master degree', 6);

INSERT INTO tbl_courses (course_id, course_description, course_duration, course_name, instructor_id) VALUES
