...
public class Course {
    ...
    @Basic //@Basic annotation on a field or a property signifies that it's a basic type and Hibernate should use the standard mapping for its persistence
    ...
    @Basic
    @Column(name = "course_description", nullable = false, length = 75)
    ...
    private Instructor instructor;   //The course can be taught by one instructor
